...
<pre syntax="ruby">
@phone = Location.find(:first, ...elided... ).andand.phone
</pre>And it does the same thing by rewriting the code into ordinary Ruby. Because you accept any method using Ruby’s method invocation syntax, Andand also lets us write methods with parameters and/or blocks:
