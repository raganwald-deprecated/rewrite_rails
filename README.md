...
Consult [the doc folder](http://github.com/raganwald/rewrite_rails/tree/master/doc ""). Every rewriter gets its own page. At the moment:

  * [Andand](http://github.com/raganwald/rewrite_rails/tree/master/doc/andand.textile "doc/andand.textile")
  * [String to Block](http://github.com/raganwald/rewrite_rails/tree/master/doc/andand.textile "doc/string_to_block.md")

More will be added as I write them or port them from the old rewrite gem.
